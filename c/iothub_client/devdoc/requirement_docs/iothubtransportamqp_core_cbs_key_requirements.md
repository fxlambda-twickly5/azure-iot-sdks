...
typedef struct AMQPTRANSPORT_CORE_STATE* AMQPTRANSPORT_CORE_HANDLE;
...
typedef AMQPTRANSPORT_SEND_STATUS (*FP_AMQPTRANSPORT_GET_SEND_STATUS)(AMQPTRANSPORT_CORE_HANDLE handle);
...
typedef int (*FP_AMQPTRANSPORT_UNREGISTER_DEVICE)(AMQPTRANSPORT_DEVICE_HANDLE handle);
typedef AMQPTRANSPORT_CORE_HANDLE (*FP_AMQPTRANSPORT_GET_TRANSPORT_HANDLE)(AMQPTRANSPORT_DEVICE_HANDLE handle);

struct AMQPTRANSPORT_CORE_INTERFACE_TAG
{
    FP_AMQPTRANSPORT_CREATE amqptransport_core_create;
    FP_AMQPTRANSPORT_DESTROY amqptransport_core_destroy;
    FP_AMQPTRANSPORT_DO_WORK amqptransport_core_do_work;
    FP_AMQPTRANSPORT_GET_SEND_STATUS amqptransport_get_send_status;
    FP_AMQPTRANSPORT_REGISTER_DEVICE amqptransport_register_device;
    FP_AMQPTRANSPORT_UNREGISTER_DEVICE amqptransport_unregister_device;
